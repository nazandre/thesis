...
void P2PNetworkInterface::send() {
	...
	messageBeingTransmitted->beginningTransmissionMacLayer();
	...
	BaseSimulator::getScheduler()->schedule(new NetworkInterfaceStopTransmittingEvent(now+transmissionDuration, this));
