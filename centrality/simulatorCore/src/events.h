...
//
//===========================================================================================================
class NetworkDequeueIncomingMsgStatEvent : public BlockEvent {
public:
  NetworkDequeueIncomingMsgStatEvent(Time t, BaseSimulator::BuildingBlock *conBlock);
  ~NetworkDequeueIncomingMsgStatEvent();
  void consumeBlockEvent();
  const virtual string getEventName();
};
